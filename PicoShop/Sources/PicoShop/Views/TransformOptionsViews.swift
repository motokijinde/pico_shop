    ...
    var body: some View {
        OptionSection(title: "選択変形") {
            if baseBounds != nil {
                ...
                HStack(spacing: 6) {
                    NumberField(label: "幅", text: $wText, width: 48, labelWidth: 20) { commitSize(.width) }
                    NumberField(label: "高さ", text: $hText, width: 48, labelWidth: 20) { commitSize(.height) }
                }
